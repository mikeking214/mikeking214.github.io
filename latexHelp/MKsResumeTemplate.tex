...
% Read all comments as they are there to help you
% Use http://nitens.org/taraborelli/cvtex as a reference
% Email me if you have questions: michael.king2@mail.mcgill.ca
%****************************************************************************************

\documentclass[11pt, letterpaper]{article} % font size, document size, "article" class
% could also use size 10pt or 12pt
...
\pagestyle{plain} % includes just page numbers
\lfoot{\hspace{2.71in}\thepage} % center page number
%\thispagestyle{empty} % ******* removes the pagenumbers (remove the \pagestyle{plain} from above)
...
\begin{minipage}[ht]{2.5in}
  ...
  \linkedin \hspace{5pt}\href{http://www.linkedin.com/in/michaelelliotking}{linkedin.com/in/michaelelliotking}\\ % LinkedIn
  \Mundus \hspace{4pt}  \href{http://www.michaelelliotking.com}{www.michaelelliotking.com} \\ % personal website
  \github \hspace{2pt} \href{http://wwww.githib.com/mikeking214}{www.github.com/mikeking214} % git
\end{minipage}\\[.1in]
...
% customize how you list your experiences, by changing the order of title or company, using italics, caps or bold, or the \small text environment
% what is important is that you remain consistent throughout with this formatting, so it is clear to the reader what 

%MCGILL ROBOTICS
  \begin{samepage}
    \years{8/2013 - Present} \textbf{\scshape Mechanical Engineering Leader | Control Systems}\\ %title of position first
...
% must use \section* with the * so that it does not number the section heading
